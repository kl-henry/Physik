...
class Ui_Physik(object):
    def setupUi(self, Physik):
        ...
        self.action1_dim_Box = QAction(Physik)
        self.action1_dim_Box.setObjectName(u"action1_dim_Box")
        self.actionDifferentialgl_Vergleich = QAction(Physik)
        self.actionDifferentialgl_Vergleich.setObjectName(u"actionDifferentialgl_Vergleich")
        ...
        self.menuMathematik.addAction(self.actionDifferentialgl_Vergleich)
        ...
        self.menuSimulation.addAction(self.action1_dim_Box)
    ...
    def retranslateUi(self, Physik):
        ...
        self.action1_dim_Box.setText(QCoreApplication.translate("Physik", u"1 dim. Box", None))
        self.actionDifferentialgl_Vergleich.setText(QCoreApplication.translate("Physik", u"Differentialgl. Vergleich", None))
        self.lbMain.setText("")
