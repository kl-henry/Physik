...
class Ui_Physik(object):
    def setupUi(self, Physik):
        ...
        self.actionHarmonischer_Oszillator_QM = QAction(Physik)
        self.actionHarmonischer_Oszillator_QM.setObjectName(u"actionHarmonischer_Oszillator_QM")
        ...
        self.menuElektrodynamik.addAction(self.actionHarmonischer_Oszillator_QM)
    ...
    def retranslateUi(self, Physik):
        ...
        self.actionHarmonischer_Oszillator_QM.setText(QCoreApplication.translate("Physik", u"Harmonischer Oszillator (QM)", None))
        self.lbMain.setText("")
